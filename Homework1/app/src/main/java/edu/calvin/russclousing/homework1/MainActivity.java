...
public class MainActivity extends AppCompatActivity {
    ...
    //overide method for on pause. stores user input that will be restored in the onresume method
    @Override
    public void onPause() {
        super.onPause();
        SharedPreferences.Editor editor = savedValues.edit();
        editor.putInt("value one", value1);
        editor.putInt("value two", value2);
    ...
    public void onResume() {
        super.onResume();
        value1 = savedValues.getInt("value one", value1);
        value2 = savedValues.getInt("value two", value2);
